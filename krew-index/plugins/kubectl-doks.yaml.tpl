...
spec:
  ...
  platforms:
    - selector: {matchLabels: {os: darwin, arch: amd64}}
      uri: https://github.com/digitalocean/kubectl-doks/releases/download/v__VERSION__/kubectl-doks-darwin-amd64.tar.gz
    ...
    - selector: {matchLabels: {os: darwin, arch: arm64}}
      uri: https://github.com/digitalocean/kubectl-doks/releases/download/v__VERSION__/kubectl-doks-darwin-arm64.tar.gz
    ...
    - selector: {matchLabels: {os: linux, arch: amd64}}
      uri: https://github.com/digitalocean/kubectl-doks/releases/download/v__VERSION__/kubectl-doks-linux-amd64.tar.gz
    ...
    - selector: {matchLabels: {os: linux, arch: arm64}}
      uri: https://github.com/digitalocean/kubectl-doks/releases/download/v__VERSION__/kubectl-doks-linux-arm64.tar.gz
